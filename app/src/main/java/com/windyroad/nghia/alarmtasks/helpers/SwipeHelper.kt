...
class SwipeHelper(dragDirs: Int, swipeDirs: Int, private val listener: RecyclerItemTouchHelperListener?, @param:IdRes private val foregroundViewId: Int) : ItemTouchHelper.SimpleCallback(dragDirs, swipeDirs) {
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        if (viewHolder != null) {
            val foregroundView = viewHolder?.itemView.findViewById<View>(foregroundViewId)
